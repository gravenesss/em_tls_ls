...
def noise_increase(noise_min, noise_max, step, test_ratio, split_num, noise_loop):
    ...
    for now_id in trange(seq_len, desc='Progress', unit='loop'):
        ...
        for split in range(split_num):
            ...
            x1_train = x1_data[:-test_last_10]  # todo 仅仅此处区别
            y1_train = y1_data[:-test_last_10]
    ...
    if True:
        ...
        x_err1_img, x_err2_img = 'noise_train.png', 'noise_test.png'
        wb_img = 'noise_w.png'
...
if __name__ == '__main__':
    ...
    only_test = False
    random_seeds = list(range(22, 23))  # 22 82没卡 90√ 91 101√ 102   27
    for random_id in random_seeds:  # trange(len(random_seeds), desc='Random Process', unit='loop'):
        ...
        if only_test:
            ...
            noise_increase(0.0, 0.5, 0.05, test_ratio=0.1, split_num=100, noise_loop=50)
    pass
